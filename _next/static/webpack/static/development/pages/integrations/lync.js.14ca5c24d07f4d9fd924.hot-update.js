webpackHotUpdate("static/development/pages/integrations/lync.js",{

/***/ "./components/integrations/SkypeForBusiness.js":
/*!*****************************************************!*\
  !*** ./components/integrations/SkypeForBusiness.js ***!
  \*****************************************************/
...
var _jsxFileName = "/Users/alihanberkbilgic/Desktop/Bilgetech/BotgateLandingPage/components/integrations/SkypeForBusiness.js";
...
function (_Component) {
  ...
  function Messenger(props) {
    ...
    _this.state = {
      icon: '/static/img/icon/skype-box.svg',
      ...
      description: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, {
        ...
        __self: this
      }, "Increase effectiveness and collaboration within your organisational processes."), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
        className: "mt-16",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 12
        ...
        __self: this
      }, "With Botgate that process can feel like a real person, and your bot can use quick actions to save more time.")),
      question: 'What are Skype for business features?',
      featureList: ['It supports customized rich messages (images, videos, links etc.)', 'It is another fast & easy way to contact your customers', 'It keeps track of the conversation history'],
      image: null,
...
//# sourceMappingURL=lync.js.14ca5c24d07f4d9fd924.hot-update.js.map